...
const propertyTypes = [
  {
    ...
    icon: MapPin,
    title: 'Plots',
    description: 'Premium residential & commercial plots in prime locations',
    count: 15,
  ...
  },
  {
    ...
    icon: Home,
    title: 'Villas',
    description: 'Luxury villas with modern amenities & elegant designs',
    count: 8,
  ...
  },
  {
    ...
    icon: Building,
    title: 'Apartments',
    description: 'Contemporary apartments with world-class facilities',
    count: 12,
