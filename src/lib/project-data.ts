...
Developed by PRIDEWALLS, Espino comprises six residential blocks (A to F) with a balanced mix of 2BHK and 3BHK homes, efficient floor plans, and excellent connectivity to schools, IT hubs, healthcare facilities, shopping, and entertainment zones. Espino stands as an ideal choice for families seeking a modern, well-connected, and community-centric lifestyle in West Hyderabad.`,
    ...
    highlights: [
      ...
      { id: '2', title: 'Transit Ready', description: 'Metro station within 10 Mins', icon: 'train' },
...
Designed for both end-users and investors, SIRI ECO SPACE combines strategic master planning with transparent documentation and straightforward booking. The project emphasizes sustainable development with rainwater harvesting, underground utilities, and landscaped common areas. Every plot is backed by complete legal compliance and flexible payment options, making it an ideal investment for long-term value appreciation.`,
    ...
    mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1276.1441629282726!2d78.15117800524085!3d17.546892743294272!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbf11a8534a8ef%3A0x4cbc50fd81137e99!2sRudraram%2C%20Telangana%20502329!5e1!3m2!1sen!2sin!4v1787294939659!5m2!1sen!2sin',
    type: 'plots',
    status: 'upcoming',
    featured: false,
    ...
    gallery: [
      ...
      '/master-plan.png',
      '/amenities-generated/security-gate.png',
      '/amenities-generated/community-garden.png',
    ],
    amenities: [
      { id: '1', name: 'Community Garden', icon: 'leaf', description: 'Landscaped gardens with recreational areas', image: '/amenities-generated/community-garden.png' },
      { id: '2', name: 'Walking Tracks', icon: 'footprints', description: 'Tree-lined walking and jogging paths', image: '/amenities-generated/walking-tracks.png' },
      { id: '3', name: 'Parks & Open Spaces', icon: 'tree-pine', description: 'Green spaces for community gathering', image: '/amenities-generated/parks-open-spaces.png' },
      { id: '4', name: 'Play Areas', icon: 'baby', description: 'Children play zones with safety features', image: '/amenities-generated/play-areas.png' },
      { id: '5', name: 'Community Hall', icon: 'home', description: 'Multi-purpose community gathering space', image: '/amenities-generated/community-hall.png' },
      { id: '6', name: 'Security Gate', icon: 'shield', description: '24/7 security with access control', image: '/amenities-generated/security-gate.png' },
    ],
    facilities: [
...
With flexible payment plans and transparent documentation, PRIDEWALLS VILLAS is an ideal choice for homeowners and investors seeking long-term appreciation in one of Hyderabad's most sought-after locations.`,
    ...
    gallery: [
      ...
      '/amenities-generated/security-gate.png',
      '/amenities-generated/swimming-pool.png',
    ],
    amenities: [
      ...
      { id: '3', name: 'Gymnasium', icon: 'dumbbell', description: 'State-of-the-art fitness center with modern equipment', image: '/amenities-generated/gymnasium1.png' },
      { id: '4', name: 'Yoga & Meditation', icon: 'flower2', description: 'Dedicated yoga and meditation hall', image: '/amenities-generated/yoga-meditation.png' },
      { id: '5', name: 'Children Play Area', icon: 'baby', description: 'Safe recreational play zones for kids', image: '/amenities-generated/play-areas.png' },
      { id: '6', name: 'Landscaped Gardens', icon: 'leaf', description: 'Beautifully landscaped common gardens', image: '/amenities-generated/community-garden.png' },
      { id: '7', name: 'Jogging Track', icon: 'footprints', description: 'Tree-lined jogging and walking tracks', image: '/amenities-generated/walking-tracks.png' },
      { id: '8', name: 'Security Gate', icon: 'shield', description: '24/7 gated security with CCTV surveillance', image: '/amenities-generated/security-gate.png' },
    ],
    facilities: [
...
export const companyInfo: CompanyInfo = {
  ...
  socialLinks: [
    { platform: 'Facebook', url: 'https://www.facebook.com/people/Pridewalls-Infratech/61589299862435', icon: 'facebook' },
    { platform: 'Instagram', url: 'https://instagram.com/pridewalls_infratech', icon: 'instagram' },
    { platform: 'LinkedIn', url: 'https://www.linkedin.com/company/pridewall', icon: 'linkedin' },
...
export const testimonials: Testimonial[] = [
  {
    ...
    name: 'Rajesh Kumar',
    location: 'Ameenpur, Hyderabad',
    content: 'We purchased an apartment in PRIDEWALLS ESPINO and are extremely satisfied with the premium quality and thoughtful design. The amenities like the clubhouse, swimming pool, and community spaces are world-class. The perfect location with excellent connectivity to IT parks. The PRIDEWALLS team was professional and supportive throughout.',
    rating: 5,
    projectPurchased: 'PRIDEWALLS ESPINO',
  },
  {
    id: '2',
    name: 'Priya Sharma',
    location: 'Ameenpur, Hyderabad',
    content: 'Living in PRIDEWALLS ESPINO has been a wonderful experience. The spacious apartments, modern interiors, and elegant architecture provide the perfect home for our family. Club Vivian is an amazing addition with its gym, swimming pool, and multipurpose facilities. Highly recommend this project!',
    rating: 5,
    projectPurchased: 'PRIDEWALLS ESPINO',
  },
  {
    ...
    name: 'Arun Menon',
    location: 'Ameenpur, Hyderabad',
    content: 'Invested in a 2BHK at PRIDEWALLS ESPINO and very satisfied with the investment quality. The infrastructure is solid, transparent documentation, and excellent property management. Strong appreciation potential in this prime location. PRIDEWALLS has delivered excellence in every aspect.',
    rating: 5,
    projectPurchased: 'PRIDEWALLS ESPINO',
  },
];
